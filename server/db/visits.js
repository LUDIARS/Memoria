...
/**
 * 外部 (Legatus DNS/SNI tap) からの domain visit を挿入する。
 * url は擬似形式 (`dns://<domain>` or `sni://<domain>`) で保存する。
 */
export function insertExternalVisitEvent(db, { domain, visitedAt, source, deviceLabel, deviceOs }) {
