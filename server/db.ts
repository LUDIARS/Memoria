...
export function openDb(dbPath: string): Db {
  ...
  // Legacy note tables remain untouched for the read-only Tabula migration.
...
export { listTasks, getTask, insertTask, updateTask, deleteTask, listTaskCategories, registerTaskCategory, unregisterTaskCategory } from './tasks/store.js';
export type { ListTasksOptions, InsertTaskInput } from './tasks/sqlite.js';
