...
| ai_articles (AIノート) | ✅ **8 型目** | 自動生成の技術記事。 ただし **禁止語スキャン必須** ([`hub-social.md`](./hub-social.md) §1.2) |
