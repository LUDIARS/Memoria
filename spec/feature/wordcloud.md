...
## データ
- [word_clouds](../data/wordcloud.md) — origin (bookmark / bookmarks / dig / merged) / parent_cloud_id / parent_word / result_json / origin_bookmark_id (CASCADE) / origin_dig_id

## API
- [dict.md](../interface/dict.md) — `/api/wordcloud*`、 `/api/wordcloud/:id/graph` (BFS で半径 1-3)、 `/api/wordcloud/:id/siblings`、 `/api/wordcloud/merge`、 `/api/wordcloud/validate-word`
